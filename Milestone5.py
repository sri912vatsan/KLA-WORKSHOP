# -*- coding: utf-8 -*-
"""
Created on Mon Jan 23 14:28:14 2023
...
path1 = r"C:\Users\sriva\OneDrive\Desktop\PSG COLLEGE\PLACEMENTS\KLA SDE\Milestone_Input\Milestone_Input\Milestone 5\Source.txt"
path2 = r"C:\Users\sriva\OneDrive\Desktop\PSG COLLEGE\PLACEMENTS\KLA SDE\Milestone_Input\Milestone_Input\Milestone 5\POI.txt"
...
f1 = open('Milestone5_output.txt','w')
...
with open(path1,'r') as file1:
    ...
    for line in data:
        if 'xy' in line:
            ...
            if int(coordinates[0])==number_of_points:
